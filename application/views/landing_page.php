    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-justify">
        <?php foreach($tentang as $ttg): ?>
          ...
          <p><strong>Sejarah Universitas Islam Negeri Sunan Kalijaga</strong>
          <?= $ttg->sejarah; ?></p>
          
          <p><strong>Visi Universitas Islam Negeri Sunan Kalijaga</strong>
          <?= $ttg->visi; ?></p>

          <p><strong>Misi Universitas Islam Negeri Sunan Kalijaga</strong>
          <?= $ttg->misi; ?></p>
        <?php endforeach; ?>
